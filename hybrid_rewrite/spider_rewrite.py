...
def predict(query_obj: dict,
    ...
    schema = get_spider_schema(query_obj.get(
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("-e", "--example_path", type=str,
                        default="./data/spider_dsl/template/spider_dev_dsl_clean.json")
...
if __name__ == "__main__":
    ...
    if not os.path.exists("./log/spider"):
        os.makedirs("./log/spider")
    with open(f"./log/spider/{test_basename.split('.')[0]}_pattern{args.pattern_top_k}_{time_str}.json", "w", encoding='utf-8') as f:
